      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          <div className="flex flex-col">
            <div className="text-lg font-serif font-bold tracking-wider mb-2">GREEK IMPERIAL</div>
          ...
          <div>
            <h3 className="text-sm font-semibold tracking-widest mb-4">NAVIGATION</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold tracking-widest mb-4">CONTACT</h3>
            <div className="space-y-3 text-sm font-light mb-6">
              <p>+234 (0) 706 0893 264</p>
              <p>info@greekimperial.com</p>
              <p className="text-xs text-primary-foreground/70">Port Harcourt, Nigeria</p>
            </div>
